...
class Fad extends Piece {
	static getMoves(color, xPos, yPos) {
		let validMoves = [];
		
		let poses = [{dx: 2, dy: 0}, {dx: 1, dy: 1}, {dx: 2, dy: 2}, {dx: 0, dy: 2}, {dx: -1, dy: 1}, {dx: -2, dy: 2}, {dx: -2, dy: 0}, {dx: -1, dy: -1}, {dx: -2, dy: -2}, {dx: 0, dy: -2}, {dx: 1, dy: -1}, {dx: 2, dy: -2}];
